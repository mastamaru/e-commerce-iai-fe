  ...
  return (
    <>
      <section className="overflow-x-hidden">
        <Navbar />
        <div className="bg-[url('/herouser.png')]  h-[320px] bg-cover overflow-x-hidden" />
        <div className="flex flex-col items-center w-full min-h-[1400px] py-[120px] bg-gray-50 justify center overflow-x-hidden">
